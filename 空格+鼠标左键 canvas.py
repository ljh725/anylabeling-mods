...
class Canvas(
    ...
    def enterEvent(self, ev):
        """Mouse enter event"""
        if not self._handle_panning_enter(ev):
    ...
    def leaveEvent(self, ev):
        ...
        self.un_highlight()
        self.restore_cursor()
        self._handle_panning_leave(ev)

    def focusOutEvent(self, ev):
        """Window out of focus event"""
        self.restore_cursor()
        self._handle_panning_focus_out(ev)
    ...
    def rotate_by_keyboard(self, theta):
        self.rotate_selected_shapes(theta)
    ...
    def keyPressEvent(self, ev):
        ...
        if self.mode == self.EDIT and not ev.isAutoRepeat():
